      ...
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          ...
          if (_t.response && _t.response.data) {
            (0, _alert.showAlert)('error', _t.response.data);
          } else {
            console.log('Unexpected error:', _t.message);
          }
        case 3:
          return _context.a(2);
      }
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          (0, _alert.showAlert)('error', 'error logged out, please try again!');
        case 3:
...
var loggedoutBtn = document.querySelector('.nav__el--logout');
if (loginForm) {
...
if (loggedoutBtn) loggedoutBtn.addEventListener('click', _login.logout);
